    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>Get started with BudgetWise for free.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
          ...
          <Button variant="outline" className="w-full gap-2" onClick={handleGoogleSignIn} disabled={isLoading || isGoogleLoading}>
